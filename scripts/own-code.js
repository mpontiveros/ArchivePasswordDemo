...
(() => {
	...
	const DEFLATE_IMPLEMENTATIONS = {
		"zip.js": ["scripts/zip.js/z-worker.js"],
		"fflate": ["scripts/zip.js/z-worker-fflate.js", "fflate.min.js"],
		"pako": ["scripts/zip.js/z-worker-pako.js", "pako_deflate.min.js"],
	};
	...
	(() => {
		...
		// let's select zip.js as deflate implementation
